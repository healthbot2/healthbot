<?php
	$con = mysqli_connect("localhost","root","","notification") or
			...
			<div class="row">
				...
				<!-- <div class="col-12 col-lg-8">
				 ...
				 <div class="col-12 col-md-5 mb-0">
                                                ...
                                                <a href="new-notification.html" class="btn medilife-btn" role="button">Add New Notification<span>+</span></a>
...
?>
    <tr>
    <td></td>
    <td><?php echo $record['ntf_id']; ?></td>
    <td><?php echo $record['ntf_msg']; ?></td>
    <td><?php echo $record['ntf_time']; ?></td>
    <td>Recepient 1</td>

    <td><p data-placement="top" data-toggle="tooltip" title="Edit"><a class="btn btn-primary btn-xs" href="<?php echo 'edit_notification.php?ntf_id='.$record['ntf_id'];?>"><span class="glyphicon glyphicon-pencil"></span></a></p></td>
